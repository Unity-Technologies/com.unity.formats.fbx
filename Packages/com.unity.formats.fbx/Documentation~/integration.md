...
To install Unity Integration for Maya, Maya LT, or 3ds Max, open [Fbx Export Settings](options.html) (menu: __Edit__ > __Project Settings__ > __Fbx Export__) in Unity:
...
If you enabled the __Keep Open__ option in the [Fbx Export Settings](options.html) window, then Maya stays open after installation completes.
